...
public class Applicant {
	...
	private Date bankruptcy_discharge_date;
	...
	private String total_other_income;
	/********************************* selection type ******************************/
	// relationship_status
	...
	// applicant_mortgage(com.syml.domain.Mortgage)-->applicant_id
	...
	// many to one : mapping table :
	// income_employer(com.syml.domain.Income)-->applicant_id
	...
	// many to one : mapping table :
	// applicant_property(com.syml.domain.Property)-->applicant_id
	...
	// many to one : mapping table :
	// crm_asset(com.syml.domain.Asset)-->opportunity_id
	...
	// many to one : mapping table :
	// applicant_collection(com.syml.domain.Collection)-->applicant_id
	...
	// many to one : mapping table :
	// applicant_liabilities(com.syml.domain.Liability)-->applicant_id
	// @ERP(name="liabilities", type = OpenERPType.one2many )
	// @JsonIgnore
	// @Transient
	public List<Integer> liabilityIds = new ArrayList<Integer>();

	// There are a few variables which are needed to hold totals for the
	// applicant. Some of these values may be sent back to OpenERP
	...
	public void setTotalApplicantPropertyTaxes(
			double totalApplicantPropertyTaxes) {
	...
	public String getTotal_other_income() {
		return total_other_income;
	}

	public void setTotal_other_income(String total_other_income) {
	...
	public String toString() {
		return "Applicant [id=" + id + ", applicantId=" + applicantId
				...
				+ totalApplicantCondoFees + ", total_rental_income="
				+ total_rental_income + ", crp_3_score=" + crp_3_score
				+ ", total_asset=" + total_asset
				+ ", bankruptcy_discharge_date=" + getBankruptcy_discharge_date()
				+ ", applicant_name=" + applicant_name
				+ ", monthly_support_payment=" + monthly_support_payment
				+ ", immigration_date=" + immigration_date
				+ ", orderly_debt_payment=" + orderly_debt_payment
				+ ", primary1=" + primary1 + ", consentDateTime="
				+ consentDateTime + ", non_resident=" + non_resident
				+ ", signature=" + signature + ", work=" + work
				+ ", email_personal=" + email_personal + ", ers2Score="
				+ ers2Score + ", cell=" + cell + ", totalNetWorth="
				+ totalNetWorth + ", bankruptcy=" + bankruptcy
				+ ", messageIsFollower=" + messageIsFollower + ", totalIncome="
				+ totalIncome + ", totalInquires=" + totalInquires + ", home="
				+ home + ", applicant_last_name=" + applicant_last_name
				+ ", credit_report=" + getCredit_report() + ", odpDischargeDate="
				+ odpDischargeDate + ", includeInOpportunity="
				+ includeInOpportunity + ", monthlychildsupport="
				+ monthlychildsupport + ", beacon_9_score=" + beacon_9_score
				+ ", beacon_5_score=" + beacon_5_score + ", money=" + money
				+ ", identity_attached=" + identity_attached
				+ ", contact_record=" + contact_record + ", ninqidx=" + ninqidx
				+ ", total_employed_income=" + total_employed_income
				+ ", email_work=" + email_work + ", sin=" + sin + ", dob="
				+ dob + ", signatureIp=" + signatureIp + ", passport="
				+ passport + ", totalOtherIncome=" + totalOtherIncome
				+ ", messageUnread=" + messageUnread + ", messageSummary="
				+ messageSummary + ", totalSelfEmployed=" + totalSelfEmployed
	...
	public Date getBankruptcy_discharge_date() {
		return bankruptcy_discharge_date;
	}

	public void setBankruptcy_discharge_date(Date bankruptcy_discharge_date) {
		this.bankruptcy_discharge_date = bankruptcy_discharge_date;
	}
